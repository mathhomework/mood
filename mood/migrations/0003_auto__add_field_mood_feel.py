...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mood.feel'
        db.add_column(u'mood_mood', 'feel',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mood.feel'
        db.delete_column(u'mood_mood', 'feel')
    ...
    models = {
        ...
        u'mood.mood': {
            ...
            'feel': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
